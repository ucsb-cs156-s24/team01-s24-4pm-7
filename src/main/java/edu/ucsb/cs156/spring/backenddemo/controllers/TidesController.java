...
public class TidesController {
    ...
    public ResponseEntity<String> getTides(
        @Parameter(name="beginDate", description="beginning date for tides YYYYmmdd", example="20240101") @RequestParam String beginDate,
        @Parameter(name="endDate", description="end date for tides YYYYmmdd", example="20240131") @RequestParam String endDate,
        @Parameter(name="station", description="weather station number", example="9411340") @RequestParam String station
